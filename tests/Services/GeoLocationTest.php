...
class GeoLocationTest extends TestCase
{
    ...
    public function setup()
    {
        ...
        $this->mock = Mockery::mock('Evinkuraga\GeoLocation\Services\GeoLocation[requestData]');
    ...
    {
        $this->assertInstanceOf(\Evinkuraga\GeoLocation\Contracts\Services\GeoLocation::class, $this->geolocation);
    }

    /**
     * @test
     * @expectedException \Evinkuraga\GeoLocation\Exceptions\PrecisionNotKnownException
     */
